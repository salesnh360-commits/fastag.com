    ...
    try {
      const payload = {
        ...
        notes: [
          ...
          `Blacklist Reason: ${String(formData.get("reason") || "").trim()}`,
    ...
    <main className="min-h-screen bg-white text-gray-900">
      <section className="py-10">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <h1 className="text-3xl font-extrabold mb-2">Blacklist Removal</h1>
          <p className="text-gray-600 mb-6">Resolve blacklist due to low balance, KYC, or issuer issues.</p>
              ...
              <form action={onSubmit} className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input id="reason" name="reason" placeholder="Low balance / KYC / Others" />
                  </div>
                </div>
                <div>
                  <Label htmlFor="details">Additional details</Label>
                  <Textarea id="details" name="details" placeholder="Brief description (e.g., date of incident, messages received)" />
                </div>
